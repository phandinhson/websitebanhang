...
class ProductController extends Controller
{
    ...
    public function store(Request $request): JsonResponse
    {
        $validator = Validator::make($request->all(), [
            ...
            'slug'        => 'nullable|string|unique:mongodb.products,slug',
            'is_active'   => 'nullable|boolean',
            'sku'         => 'nullable|string|unique:mongodb.products,sku',
    ...
    public function update(Request $request, string $id): JsonResponse
    {
        ...
        $validator = Validator::make($request->all(), [
            ...
            'slug'        => "sometimes|string|unique:mongodb.products,slug,{$id},_id",
            'is_active'   => 'sometimes|boolean',
            'sku'         => "sometimes|string|unique:mongodb.products,sku,{$id},_id",
